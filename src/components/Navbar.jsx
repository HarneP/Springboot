...
const Navbar = () => {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark py-3 sticky-top" style={{backgroundColor: "Teal", height: 75}}> {/*darken the nav bar*/} 
            <ToastContainer />
            <div className="container">
            { ! (user?.role===Role.ADMIN) ?
                <NavLink className="navbar-brand fw-bold fs-4 px-2" to="/product"> LAZZY PLAY</NavLink>
                :
                <NavLink className="navbar-brand fw-bold fs-4 px-2" to="/updateproduct"> LAZZY PLAY</NavLink> 
            }
                {}
