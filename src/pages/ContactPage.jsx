    ...
    <>
      <section className="section-contact">
        ...
        <div className="main-contact">
          ...
          <div>
            <div className="headingContainer">
              ...
              <h1>Get In Touch</h1>
              <p>
                We'd love to hear from you. Take five minutes to fill out our
                form so that we can get to know you.
              </p>
            </div>
          </div>
        </div>
        <div class="container my-5 py-5">
          <div class="row">
            <div class="col-md-6 mx-auto bg-secondary p-5 contactDiv">
              {/* <div class="col-md-6 mx-auto bg-success p-5 contactDiv"> */}
              ...
              <form class="my-5" onSubmit={handleSubmit}>
                ...
                <div class="form-group my-3">
                  ...
                  <textarea
                    ...
                    class="form-control"
                    id="Password"
                    placeholder="Feel free to say kind words.."
                  ></textarea>
                </div>
